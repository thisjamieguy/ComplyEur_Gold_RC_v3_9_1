...
def setup_news_sources(db_path):
    ...
    # Note: Real news will be fetched automatically by the news fetcher service
    # No need to add sample data as the RSS feeds will provide real content
    ...
    print('ℹ️  News items will be fetched automatically from RSS feeds')
