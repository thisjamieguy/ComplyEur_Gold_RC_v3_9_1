...
def calculate_eu_days_from_trips(trips: List[Dict], reference_date: datetime.date) -> int:
    """Calculate EU days within 180-day window from reference_date."""
    ...
    for trip in trips:
        ...
        effective_exit = min(exit_date, reference_date)
...
def export_trips_csv(db_path: str, employee_id: int = None) -> str:
    ...
    writer.writerow(['Employee Name', 'Country', 'Entry Date', 'Exit Date', 'Travel Days'])
