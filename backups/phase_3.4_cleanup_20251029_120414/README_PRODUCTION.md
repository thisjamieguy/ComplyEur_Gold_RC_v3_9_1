...
- 🔒 GDPR compliant with automatic data retention policies
- 📊 Real-time compliance tracking with risk level alerts
- 💾 Automatic database backups on startup and shutdown
- 📥 Excel import/export capabilities
- 🛡️ Secure password hashing (Argon2) and session management
...
### Exporting Data
- **CSV Export:** Dashboard → "Export All Trips (CSV)"
- **PDF Reports:** Employee Detail → "Export PDF Report"
- **DSAR Export:** Privacy Tools → Select employee → "Export Data"
...
- If changed and forgotten, delete `eu_tracker.db` to reset (⚠️ deletes all data)
...
```
EU_Travel_Tracker/
├── Run_App.bat              # Main startup script (use this)
├── START_APP_SIMPLE.bat     # Quick start (after initial setup)
...
├── instance/                # Data and backups
│   ├── backups/             # Automatic database backups
│   ├── exports/             # DSAR exports
│   └── logs/                # Audit logs
│
├── data/                    # Reference data (EU entry requirements)
...
2. Or use **Admin Settings** → **"Create Backup"**
...
- ✅ 404/500 error pages with proper logging
- ✅ Comprehensive test suite (pytest)
- ✅ Windows deployment scripts (Run_App.bat)
