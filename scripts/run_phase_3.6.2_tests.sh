...
#  Phase 3.6.2 Automated Test Runner
#  Author: James Walsh / Maavsi Dev Team
# ==========================================================

REPORTS_DIR="./reports"
REPORT_FILE="${REPORTS_DIR}/phase_3.6.2_summary.txt"
