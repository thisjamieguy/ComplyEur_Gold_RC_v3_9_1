...
class UserPreferences {
    ...
    createSettingsPanel() {
        // Add settings button to topbar if it doesn't exist
        const topbarRight = document.querySelector('.topbar-right');
        if (topbarRight && !document.getElementById('settingsBtn')) {
            ...
            `;
            settingsBtn.style.cssText = 'display: flex; align-items: center; gap: 6px; padding: 8px 14px; font-size: 14px;';
            settingsBtn.onclick = () => this.openSettingsModal();
            topbarRight.insertBefore(settingsBtn, topbarRight.firstChild);
        }
    }
